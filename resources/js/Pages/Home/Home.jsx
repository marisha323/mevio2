...
function StartPage() {
  return (
    ...
    <div className="topMenuLogin">
        <h4>MEVIO</h4>
        <a href=""><h4>Увійти</h4></a>
      </div>
      <div className="StartBody">
      <div className="startGImage">
        <div className="h1-btn-register">
          <h1 className="h1Mevio">MEVIO Версія 2 <span>допомагає зібрати всіх співробітників, завдання та інструменти в одному місці</span></h1>
          <button className="register-btn">Зареєструйтесь</button>
          <img className="vector" src="images/Vector.png" alt="Vector" />
        </div>
      </div>
        <h5>MEVIO Версія 2</h5>
        ...
        <div className="Columns">
            <h4>Колонки</h4>
            <p>
            Різні етапи виконання завдання. Почніть із простих етапів (&lt;&lt; Потрібно)
            зробити&gt;&gt;, &lt;&lt;В работе&gt;&gt;, &lt;&lt;Готово&gt;&gt;) або
                створіть власний робочий процес, який точно відповідає вашим потребам
                команди. У <span>MEVIO</span> немає неправильних підходів.
            </p>
        </div>
        <div className="Columns">
            <h4>Картки</h4>
        ...
        <ul className="protectionList">
            <li>У MEVIO, ми серйозно ставимося до вашої конфіденційності та безпеки.</li>
            ...
            <li>Інші функції безпеки верхнього рівня включають стандартне 256-бітове шифрування SSL, двофакторну автентифікацію та детальні дозволи у додатках.</li>
        </ul>
      ...
      <div className="Start-Footer">
        ...
        <h5>Про нас<span><br/>Контракти</span></h5>
