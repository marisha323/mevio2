...
function StartPage() {
  return (
    ...
    <div className="topMenuLogin">
      <img className="mevislogo" src="images/mevis.jpg" alt="mesiv" />
        <Link href={"/login"}><h4>Увійти</h4></Link>
      </div>
      <div className="StartBody">
      <div className="startGImage">
        <div className="h1-btn-register">
          <h1 className="h1Mevio">MEVIS <span>допомагає зібрати всіх співробітників, завдання та інструменти в одному місці</span></h1>
        ...
        <div className="Columns">
            <h4>Дошки</h4>
            <p>Завдяки дошкам<span> MEVIS </span>завдання упорядковуються, а робота рухається.
        ...
        <div className="Columns">
            ...
            <p>
                ...
                команди. В <span>MEVIS</span> немає неправильних підходів.
            </p>
        </div>
        <div className="Columns">
            <h4>Картки</h4>
        ...
        <ul className="protectionList">
            <li>В MEVIS,ми серйозно ставимося до вашої конфіденційності та безпеки.</li>
            <li>MEVIS є сервісом, сертифікованим Trusted Cloud, та повністю відповідає EU-GDPR.</li>
      ...
      <div className="Start-Footer">
        <h5>MEVIS<br/><br/><br/><br/><br/><span className="Language">🌍Українська</span></h5>
